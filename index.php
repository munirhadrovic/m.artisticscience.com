...
<html>
	<head>
		<title>Artistic Science | Event Services and Show Production</title>
	...
	<body>
        ...
        <div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1 style="font-weight: normal; font-size: 13px;">Powered By <a href="http://mobilegrows.com/" rel="external" style="text-decoration: none;">MobileGrows</a> | <a href="http://artisticscience.com/wpsite.html/" rel="external" style="text-decoration: none;">  Desktop Site</a></h1>
        </div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left" href="#page2" data-transition="<?php echo $transitionefect ?>">Site Map</a>
                  </div>
              </div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-contact">
							<ul id="menu-contact">
                                ...
                                <li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Shop</a></li>
                                <li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Site Map</a></li>
